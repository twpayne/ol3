goog.provide('ol.source.ImageTile');
 ...
 */
ol.source.ImageTile = function(options) {
...
goog.inherits(ol.source.ImageTile, ol.source.Tile);


/**
 * @inheritDoc
 */
ol.source.ImageTile.prototype.canExpireCache = function() {
 ...
 * @inheritDoc
 */
ol.source.ImageTile.prototype.expireCache = function(usedTiles) {
 ...
 * @inheritDoc
 */
ol.source.ImageTile.prototype.getTile = function(z, x, y, projection) {
 ...
 * @inheritDoc
 */
ol.source.ImageTile.prototype.useTile = function(z, x, y) {
  var tileCoordKey = ol.TileCoord.getKeyZXY(z, x, y);
  if (this.tileCache_.containsKey(tileCoordKey)) {
