goog.provide('ol.source.DebugTile');
 ...
 * @param {ol.source.DebugTileOptions} options Debug tile options.
 */
ol.source.DebugTile = function(options) {
...
goog.inherits(ol.source.DebugTile, ol.source.Tile);


/**
 * @inheritDoc
 */
ol.source.DebugTile.prototype.canExpireCache = function() {
 ...
 * @inheritDoc
 */
ol.source.DebugTile.prototype.expireCache = function(usedTiles) {
 ...
 * @inheritDoc
 */
ol.source.DebugTile.prototype.getTile = function(z, x, y) {
